  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden p-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="breathing absolute top-1/4 -left-20 h-96 w-96 rounded-full bg-gaming-primary/20 blur-3xl" />
        <div
          className="breathing absolute -right-20 bottom-1/4 h-96 w-96 rounded-full bg-gaming-secondary/20 blur-3xl"
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-gaming-primary via-gaming-secondary to-gaming-primary opacity-30 blur-lg" />
          ...
          <div className="mb-8 text-center">
            <div className="mb-4 inline-flex items-center justify-center">
              <div className="relative">
                <div className="absolute inset-0 rounded-xl bg-gaming-primary/30 blur-lg" />
                <div className="relative rounded-xl bg-gradient-to-br from-gaming-primary to-gaming-secondary p-4">
                  <Gamepad2Icon className="size-8 text-white" />
                </div>
              </div>
            </div>
            <h1 className="mb-2 font-bold text-2xl">{m.welcomeBack()}</h1>
