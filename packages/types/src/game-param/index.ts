...
export interface GameParamFieldDef {
  /** Field key used in the params object */
  key: string;
 ...
 * This is the core discriminated union for type safety
 */
...
/**
 * Verified account data structure (returned after account check)
 */
...
// =============================================================================
// FIELD DEFINITIONS FOR RENDERERS
// =============================================================================

/**
 * Field definitions for each game's input form
 * Used by renderers to dynamically generate forms
 */
...
/**
 * Get typed game params for a specific game (for callback processing)
 * Returns null if data is invalid or not match expected structure
 */
 ...
 * Actual validation is done at component level with type inference
 */
